...
export function LatestTableRowSkeleton() {
    return (
        <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4">
            <div className="flex items-center">
                <div className="mr-2 h-8 w-8  bg-gray-200" />
        ...
        <tr className="w-full border-b border-gray-100 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
            ...
            <td className="whitespace-nowrap py-3 pl-6 pr-3">
                <div className="flex justify-end gap-3">
                    <div className="h-[38px] w-[38px] bg-gray-100"></div>
                    <div className="h-[38px] w-[38px] bg-gray-100"></div>
                </div>
            </td>
        </tr>
    ...
    return (
        <div className="mb-2 w-full  bg-white p-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-8">
                <div className="flex items-center">
                    <div className="mr-2 h-8 w-8  bg-gray-100"></div>
                    <div className="h-6 w-16 bg-gray-100"></div>
                </div>
                <div className="h-6 w-16 bg-gray-100"></div>
            </div>
            <div className="flex w-full items-center justify-between pt-4">
                <div>
                    <div className="h-6 w-16 bg-gray-100"></div>
                    <div className="mt-2 h-6 w-24 bg-gray-100"></div>
                </div>
