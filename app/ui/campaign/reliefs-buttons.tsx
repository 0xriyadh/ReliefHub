...
export function CreateRelief({ campaignId }: { campaignId: string }) {
  return (
    <Link
      href={`/admin/campaigns/${campaignId}/reliefs/create`}
    ...
    >
      <span className="hidden md:block">Create Relief</span>{' '}
...
export async function DeleteRelief({ reliefId }: { reliefId: string }) {
