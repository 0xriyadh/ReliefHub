import { deleteCampaignStock, deleteCampaignTeam, deleteDonation } from '@/app/lib/actions';
import { PencilIcon, PlusIcon, TrashIcon } from '@heroicons/react/24/outline';
import Link from 'next/link';

export function CreateDonation({ campaignId }: { campaignId: string }) {
  return (
    <Link
...
export async function DeleteDonation({ donationId }: { donationId: string }) {
  const deleteDonationWithId = deleteDonation.bind(null, donationId);
  return (
    <>
