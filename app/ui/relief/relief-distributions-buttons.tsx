...
export function DistributeRelief({ reliefId }: { reliefId: string }) {
  return (
    <Link
      href={`/admin/relief/${reliefId}/distributions/create`}
    ...
    >
      <span className="hidden md:block">Distribute Relief</span>{' '}
